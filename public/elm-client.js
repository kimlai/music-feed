...
var _user$project$Feed_Ports$resume = _elm_lang$core$Native_Platform.outgoingPort(
	'resume',
	function (v) {
	...
	function (message, model) {
		...
		while (true) {
			...
			switch (_p1.ctor) {
				...
				case 'FetchFail':
					var _p4 = A2(_elm_lang$core$Debug$log, 'could not fetch', _p1._1);
				...
				case 'PlayFromPlaylist':
					var msg = _elm_lang$core$Native_Utils.eq(
						_user$project$Player$currentTrack(model.player),
						_elm_lang$core$Maybe$Just(_p1._2.id)) ? _user$project$Feed_Update$TogglePlayback : _user$project$Feed_Update$Play;
					var _v1 = msg,
						_v2 = _elm_lang$core$Native_Utils.update(
						model,
						{
							player: A3(_user$project$Player$select, _p1._0, _p1._1, model.player)
						});
					message = _v1;
					model = _v2;
					continue update;
				...
				case 'TogglePlayback':
					if (model.playing) {
						var _v4 = _user$project$Feed_Update$Pause,
							_v5 = model;
						message = _v4;
						model = _v5;
						continue update;
					} else {
						var _v6 = _user$project$Feed_Update$Play,
							_v7 = model;
						message = _v6;
						model = _v7;
						continue update;
				...
				case 'Next':
					var _v8 = _user$project$Feed_Update$Play,
				...
				case 'PlayFromCustomQueue':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								playing: true,
								player: A3(_user$project$Player$select, _user$project$Feed_Model$CustomQueue, _p1._0, model.player)
							}),
						_1: _user$project$Feed_Ports$playTrack(
				...
				case 'BlacklistTrack':
					...
					var _p15 = A2(
						...
						A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$Blacklist, _p1._0),
						newModel);
				...
				case 'ResolveTrackInfoSuccess':
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[command, command$]));
				default:
					var _p19 = _elm_lang$core$Char$fromCode(_p1._0);
					switch (_p19.valueOf()) {
						case 'n':
							var _v12 = _user$project$Feed_Update$Next,
								_v13 = model;
							message = _v12;
							model = _v13;
							continue update;
						case 'p':
							var _v14 = _user$project$Feed_Update$TogglePlayback,
								_v15 = model;
							message = _v14;
							model = _v15;
							continue update;
						case 'l':
							var _v16 = _user$project$Feed_Update$FastForward,
								_v17 = model;
							message = _v16;
							model = _v17;
							continue update;
						case 'h':
							var _v18 = _user$project$Feed_Update$Rewind,
								_v19 = model;
							message = _v18;
							model = _v19;
							continue update;
						case 'L':
							...
							if (_p20.ctor === 'Just') {
								...
								switch (_p21.ctor) {
									case 'Feed':
										var _v22 = _user$project$Feed_Update$ChangePage('/saved-tracks'),
											_v23 = model;
										message = _v22;
										model = _v23;
										continue update;
									case 'SavedTracks':
										var _v24 = _user$project$Feed_Update$ChangePage('/published-tracks'),
											_v25 = model;
										message = _v24;
										model = _v25;
										continue update;
									case 'PublishedTracks':
										var _v26 = _user$project$Feed_Update$ChangePage('/'),
											_v27 = model;
										message = _v26;
										model = _v27;
										continue update;
						...
						case 'H':
							...
							if (_p22.ctor === 'Just') {
								...
								switch (_p23.ctor) {
									case 'Feed':
										var _v30 = _user$project$Feed_Update$ChangePage('/published-tracks'),
											_v31 = model;
										message = _v30;
										model = _v31;
										continue update;
									case 'SavedTracks':
										var _v32 = _user$project$Feed_Update$ChangePage('/'),
											_v33 = model;
										message = _v32;
										model = _v33;
										continue update;
									case 'PublishedTracks':
										var _v34 = _user$project$Feed_Update$ChangePage('/saved-tracks'),
											_v35 = model;
										message = _v34;
										model = _v35;
										continue update;
						...
						case 'm':
							...
							if (_p24.ctor === 'Just') {
								var _v37 = _user$project$Feed_Update$FetchMore(_p24._0),
									_v38 = model;
								message = _v37;
								model = _v38;
								continue update;
						...
						case 'b':
							...
							if (_p25.ctor === 'Nothing') {
								...
								var _v40 = _user$project$Feed_Update$BlacklistTrack(_p25._0),
									_v41 = model;
								message = _v40;
								model = _v41;
								continue update;
						...
						case 's':
							...
							if (_p26.ctor === 'Nothing') {
								...
								var _v43 = A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$SavedTracks, _p26._0),
									_v44 = model;
								message = _v43;
								model = _v44;
								continue update;
						...
						case 'P':
							...
							if (_p27.ctor === 'Nothing') {
								...
								var _v46 = A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$PublishedTracks, _p27._0),
									_v47 = model;
								message = _v46;
								model = _v47;
								continue update;
