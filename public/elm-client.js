...
var _user$project$Feed_Ports$changeCurrentTime = _elm_lang$core$Native_Platform.outgoingPort(
	'changeCurrentTime',
	function (v) {
		return v;
	});
			...
			switch (_p2.ctor) {
					...
					if (_p6.ctor === 'Nothing') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{playing: true}),
							_1: _user$project$Feed_Ports$playTrack(
				...
				case 'Pause':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{playing: false}),
						_1: _user$project$Feed_Ports$pause(
							_user$project$Player$currentTrack(model.player))
					};
				case 'TrackError':
					...
					var _p8 = A2(_user$project$Feed_Update$update, _user$project$Feed_Update$Next, newModel);
					var newModel$ = _p8._0;
					var command = _p8._1;
				...
				case 'PlayFromCustomQueue':
					...
					return {
						...
						_1: _user$project$Feed_Ports$playTrack(
							{id: _p9.id, streamUrl: _p9.streamUrl, currentTime: _p9.currentTime})
					};
				case 'TrackProgress':
					return {
						ctor: '_Tuple2',
				...
				case 'FastForward':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Feed_Ports$changeCurrentTime(10)
					};
				case 'Rewind':
					return {
						ctor: '_Tuple2',
				...
				case 'PublishFromSoundcloudUrlSuccess':
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[command, command$]));
				default:
					var _p19 = _elm_lang$core$Char$fromCode(_p2._0);
					switch (_p19.valueOf()) {
						case 'n':
						...
						case 'm':
							...
							if (_p24.ctor === 'Just') {
								var _v38 = _user$project$Feed_Update$FetchMore(_p24._0),
									_v39 = model;
								message = _v38;
								model = _v39;
								continue update;
						...
						case 'b':
							...
							if (_p25.ctor === 'Nothing') {
								...
								var _v41 = _user$project$Feed_Update$BlacklistTrack(_p25._0),
									_v42 = model;
								message = _v41;
								model = _v42;
								continue update;
						...
						case 's':
							...
							if (_p26.ctor === 'Nothing') {
								...
								var _v44 = A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$SavedTracks, _p26._0),
									_v45 = model;
								message = _v44;
								model = _v45;
								continue update;
						...
						case 'P':
							...
							if (_p27.ctor === 'Nothing') {
								...
								var _v47 = A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$PublishedTracks, _p27._0),
									_v48 = model;
								message = _v47;
								model = _v48;
								continue update;
...
var _user$project$Feed_Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Feed_Ports$trackProgress(_user$project$Feed_Update$TrackProgress),
				_user$project$Feed_Ports$trackEnd(
				function (_p0) {
