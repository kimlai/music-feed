...
var _user$project$Playlist$initialModel = function (initialUrl) {
	return {
...
var _user$project$Playlist$Track = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, artist: b, artwork_url: c, title: d, streamUrl: e, createdAt: f, progress: g, currentTime: h};
	});
...
var _user$project$Playlist$fetch = function (nextLink) {
	return A2(_evancz$elm_http$Http$get, _user$project$Playlist$decodeFeed, nextLink);
};
var _user$project$Playlist$Model = F3(
	function (a, b, c) {
		...
		switch (_p3.ctor) {
			...
			case 'AddTrack':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							trackIds: A2(_elm_lang$core$List_ops['::'], _p3._0, model.trackIds)
						}),
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Nothing
				};
			case 'OnTrackClicked':
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Just(
						A2(_user$project$Playlist$TrackWasClicked, _p3._0, _p3._1))
				};
			default:
				return {
					ctor: '_Tuple3',
					...
					_1: _elm_lang$core$Platform_Cmd$none,
					_2: _elm_lang$core$Maybe$Just(
						_user$project$Playlist$TrackWasAddedToCustomQueue(_p3._0))
				};
		}
	});

var _user$project$FeedApi$body = function (trackId) {
...
var _user$project$FeedApi$publish = function (trackId) {
	return A2(
		_evancz$elm_http$Http$fromJson,
		...
		A2(
			...
			_evancz$elm_http$Http$defaultSettings,
			{
				...
				url: '/publish_track',
				body: _user$project$FeedApi$body(trackId)
			}));
};
var _user$project$FeedApi$save = function (trackId) {
	return A2(
		_evancz$elm_http$Http$fromJson,
		_elm_lang$core$Json_Decode$succeed('ok'),
		A2(
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {tracks: a, feed: b, savedTracks: c, publishedTracks: d, queue: e, customQueue: f, playing: g, currentTrack: h, currentPlaylist: i, currentPage: j, lastKeyPressed: k, currentTime: l};
											};
										};
									};
								};
	...
	function (playlistId, trackId) {
		...
		switch (_p2.ctor) {
			...
			case 'SavedTracks':
				return A3(
					_elm_lang$core$Task$perform,
					_user$project$Main$MoveToPlaylistFail,
					function (_p3) {
						return _user$project$Main$MoveToPlaylistSuccess;
					},
					_user$project$FeedApi$save(trackId));
			default:
				return A3(
					_elm_lang$core$Task$perform,
					_user$project$Main$MoveToPlaylistFail,
					...
					_user$project$FeedApi$publish(trackId));
		}
	});
var _user$project$Main$MoveToPlaylist = F2(
	function (a, b) {
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$src(_p7.artwork_url)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(_p7.artist)
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(_p7.title)
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_1: A2(
															_elm_lang$core$Basics_ops['++'],
															_elm_lang$core$Basics$toString(_p7.progress),
															'%')
													}
													]))
											]),
...
var _user$project$Main$init = function (page) {
	return {
		...
		_0: {
			...
			feed: _user$project$Playlist$initialModel('/feed'),
			savedTracks: _user$project$Playlist$initialModel('/saved-tracks'),
			publishedTracks: _user$project$Playlist$initialModel('/published-tracks'),
...
var _user$project$Main$handlePlaylistMsg = F3(
	function (playlistId, playlistMsg, model) {
		var _p9 = function () {
			var _p10 = playlistId;
			switch (_p10.ctor) {
				case 'Feed':
					return A2(_user$project$Playlist$update, playlistMsg, model.feed);
				case 'SavedTracks':
					return A2(_user$project$Playlist$update, playlistMsg, model.savedTracks);
				default:
					return A2(_user$project$Playlist$update, playlistMsg, model.publishedTracks);
			}
		}();
			...
			switch (_p11.ctor) {
				case 'Feed':
					return _elm_lang$core$Native_Utils.update(
						model,
						{feed: updatedPlaylist});
				case 'SavedTracks':
					return _elm_lang$core$Native_Utils.update(
						model,
						{savedTracks: updatedPlaylist});
				default:
					return _elm_lang$core$Native_Utils.update(
						model,
						{publishedTracks: updatedPlaylist});
			}
		}();
		var _p12 = event;
		if (_p12.ctor === 'Nothing') {
			return {
				...
				_1: A2(
					_elm_lang$core$Platform_Cmd$map,
					_user$project$Main$PlaylistMsg(playlistId),
					command)
			};
		} else {
			var _p13 = A2(
				_user$project$Main$update,
				A2(_user$project$Main$PlaylistEvent, playlistId, _p12._0),
				updatedModel);
		...
		while (true) {
			...
			switch (_p14.ctor) {
				...
				case 'PlaylistEvent':
					...
					switch (_p15.ctor) {
						case 'NewTracksWereFetched':
							var _p16 = _p15._0._0;
							var updatedQueue = _elm_lang$core$Native_Utils.eq(model.currentPage, _p19) ? model.queue : A2(
								_elm_lang$core$List$append,
								model.queue,
								A2(
									_elm_lang$core$List$map,
						...
						case 'TrackWasClicked':
							...
							var playlistTracks = function () {
								...
								switch (_p17.ctor) {
									case 'Feed':
										return model.feed.trackIds;
									case 'SavedTracks':
										return model.savedTracks.trackIds;
									default:
										return model.publishedTracks.trackIds;
								}
							}();
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										newModel,
										{
											...
											playing: true,
											queue: A2(_elm_lang$core$List$drop, _p15._0 + 1, playlistTracks)
										}),
									_1: _user$project$Main$playTrack(
										{id: _p18.id, streamUrl: _p18.streamUrl, currentTime: _p18.currentTime})
								};
							}
						default:
							return {
				...
				case 'Next':
					...
					var model$ = function () {
						var _p20 = nextTrackInCustomQueue;
						if (_p20.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									currentTrack: _elm_lang$core$Maybe$Just(_p20._0),
					...
					return {
						...
						_0: model$,
						_1: function () {
							var _p21 = model$.currentTrack;
							if (_p21.ctor === 'Nothing') {
								return _user$project$Main$pause(model.currentTrack);
							} else {
								var _p22 = A2(_elm_lang$core$Dict$get, _p21._0, model.tracks);
								if (_p22.ctor === 'Nothing') {
									return _elm_lang$core$Platform_Cmd$none;
								} else {
									var _p23 = _p22._0;
									return _user$project$Main$playTrack(
				...
				case 'PlayFromCustomQueue':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								playing: true,
								currentTrack: _elm_lang$core$Maybe$Just(_p24.id),
								customQueue: A2(
									_elm_lang$core$List$filter,
									F2(
										function (x, y) {
				...
				case 'Blacklist':
					var _p27 = _p14._0;
					var _p25 = _elm_lang$core$Native_Utils.eq(
						model.currentTrack,
						_elm_lang$core$Maybe$Just(_p27)) ? A2(_user$project$Main$update, _user$project$Main$Next, model) : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					var newModel = _p25._0;
					var commands = _p25._1;
					var _p26 = A3(
						_user$project$Main$applyMessageToPlaylists,
						_user$project$Playlist$RemoveTrack(_p27),
						newModel,
						_elm_lang$core$Native_List.fromArray(
							[_user$project$Main$Feed, _user$project$Main$SavedTracks, _user$project$Main$PublishedTracks]));
					var newModel$ = _p26._0;
					var commands$ = _p26._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							newModel$,
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							_elm_lang$core$Native_List.fromArray(
								[
									commands,
									commands$,
									_user$project$Main$blacklist(_p27)
								]))
					};
				case 'BlacklistFail':
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				...
				case 'MoveToPlaylist':
					...
					var _p28 = A3(
						_user$project$Main$applyMessageToPlaylists,
						_user$project$Playlist$RemoveTrack(_p31),
						model,
						A2(
							_elm_lang$core$List$filter,
							F2(
					...
					var _p29 = A3(
						_user$project$Main$applyMessageToPlaylists,
						_user$project$Playlist$AddTrack(_p31),
						newModel,
						_elm_lang$core$Native_List.fromArray(
							[_p30]));
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							_elm_lang$core$Native_List.fromArray(
								[
									command,
									command$,
									A2(_user$project$Main$moveToPlaylist, _p30, _p31)
								]))
					};
				...
				default:
					var _p32 = _elm_lang$core$Char$fromCode(_p14._0);
					switch (_p32.valueOf()) {
						case 'n':
							var _v15 = _user$project$Main$Next,
								_v16 = model;
							message = _v15;
							model = _v16;
							continue update;
						case 'p':
							var _v17 = _user$project$Main$TogglePlayback,
								_v18 = model;
							message = _v17;
							model = _v18;
							continue update;
						case 'l':
							var _v19 = _user$project$Main$FastForward,
								_v20 = model;
							message = _v19;
							model = _v20;
							continue update;
						case 'h':
							var _v21 = _user$project$Main$Rewind,
								_v22 = model;
							message = _v21;
							model = _v22;
							continue update;
						case 'L':
							var _p33 = model.currentPage;
							switch (_p33.ctor) {
								case 'Feed':
									var _v24 = _user$project$Main$ChangePage('/saved-tracks'),
										_v25 = model;
									message = _v24;
									model = _v25;
									continue update;
								case 'SavedTracks':
									var _v26 = _user$project$Main$ChangePage('/published-tracks'),
										_v27 = model;
									message = _v26;
									model = _v27;
									continue update;
								default:
									var _v28 = _user$project$Main$ChangePage('/'),
										_v29 = model;
									message = _v28;
									model = _v29;
									continue update;
						...
						case 'H':
							var _p34 = model.currentPage;
							switch (_p34.ctor) {
								case 'Feed':
									var _v31 = _user$project$Main$ChangePage('/published-tracks'),
										_v32 = model;
									message = _v31;
									model = _v32;
									continue update;
								case 'SavedTracks':
									...
									continue update;
								default:
									var _v35 = _user$project$Main$ChangePage('/saved-tracks'),
										_v36 = model;
									message = _v35;
									model = _v36;
									continue update;
						...
						case 'm':
							var _v37 = A2(_user$project$Main$PlaylistMsg, model.currentPage, _user$project$Playlist$FetchMore),
								_v38 = model;
							message = _v37;
							model = _v38;
							continue update;
						case 'b':
							var _p35 = model.currentTrack;
							if (_p35.ctor === 'Nothing') {
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							} else {
								var _v40 = _user$project$Main$Blacklist(_p35._0),
									_v41 = model;
								message = _v40;
								model = _v41;
								continue update;
						...
						case 's':
							var _p36 = model.currentTrack;
							if (_p36.ctor === 'Nothing') {
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							} else {
								var _v43 = A2(_user$project$Main$MoveToPlaylist, _user$project$Main$SavedTracks, _p36._0),
									_v44 = model;
								message = _v43;
								model = _v44;
								continue update;
						...
						case 'P':
							var _p37 = model.currentTrack;
							if (_p37.ctor === 'Nothing') {
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							} else {
								var _v46 = A2(_user$project$Main$MoveToPlaylist, _user$project$Main$PublishedTracks, _p37._0),
									_v47 = model;
								message = _v46;
								model = _v47;
								continue update;
...
var _user$project$Main$applyMessageToPlaylists = F3(
	function (playlistMsg, model, playlistIds) {
		return A3(
			_elm_lang$core$List$foldr,
			F2(
				function (playlistId, _p38) {
					var _p39 = _p38;
					var _p40 = A3(_user$project$Main$handlePlaylistMsg, playlistId, playlistMsg, _p39._0);
					var m$ = _p40._0;
					var c$ = _p40._1;
					return {
						ctor: '_Tuple2',
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						function () {
						var _p41 = model.currentPage;
						switch (_p41.ctor) {
							case 'Feed':
								return A2(
									_elm_lang$html$Html_App$map,
									_user$project$Main$PlaylistMsg(_user$project$Main$Feed),
									A3(_user$project$Playlist$view, model.currentTime, model.tracks, model.feed));
							case 'SavedTracks':
								return A2(
									_elm_lang$html$Html_App$map,
									_user$project$Main$PlaylistMsg(_user$project$Main$SavedTracks),
									A3(_user$project$Playlist$view, model.currentTime, model.tracks, model.savedTracks));
							default:
								return A2(
									_elm_lang$html$Html_App$map,
									_user$project$Main$PlaylistMsg(_user$project$Main$PublishedTracks),
									A3(_user$project$Playlist$view, model.currentTime, model.tracks, model.publishedTracks));
						}
					}()
					]))
			]));
