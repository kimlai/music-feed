...
var _user$project$Feed_Model$currentPlaylist = function (model) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filter,
			function (_p0) {
...
var _user$project$Feed_Model$NavigationItem = F2(
	function (a, b) {
		return {displayName: a, href: b};
	});
var _user$project$Feed_Model$Page = F2(
	function (a, b) {
		return {url: a, playlist: b};
	});
var _user$project$Feed_Model$Playlist = F4(
	function (a, b, c, d) {
		return {id: a, loading: b, nextLink: c, addTrackUrl: d};
	});
var _user$project$Feed_Model$CustomQueue = {ctor: 'CustomQueue'};
var _user$project$Feed_Model$Blacklist = {ctor: 'Blacklist'};
var _user$project$Feed_Model$PublishedTracks = {ctor: 'PublishedTracks'};
var _user$project$Feed_Model$SavedTracks = {ctor: 'SavedTracks'};
var _user$project$Feed_Model$Feed = {ctor: 'Feed'};

var _user$project$Feed_Ports$scroll = _elm_lang$core$Native_Platform.outgoingPort(
	'scroll',
	function (v) {
		return v;
	});
...
var _user$project$Soundcloud$decodeTrack = A2(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$succeed(0)),
	_elm_lang$core$Json_Decode$succeed(false));
var _user$project$Soundcloud$resolve = F2(
	function (clientId, url) {
		return A2(
			_evancz$elm_http$Http$get,
			_user$project$Soundcloud$decodeTrack,
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$Feed_Update$SeekTo = function (a) {
...
var _user$project$Feed_Update$AddTrackFail = function (a) {
	return {ctor: 'AddTrackFail', _0: a};
};
var _user$project$Feed_Update$addTrack = F2(
	function (addTrackUrl, trackId) {
		return A3(
			_elm_lang$core$Task$perform,
			_user$project$Feed_Update$AddTrackFail,
			function (_p0) {
				return _user$project$Feed_Update$AddTrackSuccess;
			},
			A2(_user$project$Api$addTrack, addTrackUrl, trackId));
	});
var _user$project$Feed_Update$FetchSuccess = F2(
	function (a, b) {
		return {ctor: 'FetchSuccess', _0: a, _1: b};
	});
var _user$project$Feed_Update$FetchFail = F2(
	function (a, b) {
		return {ctor: 'FetchFail', _0: a, _1: b};
	});
var _user$project$Feed_Update$fetchMore = function (playlist) {
	var trackDecoder = function () {
		var _p1 = playlist.id;
		if (_p1.ctor === 'PublishedTracks') {
			return _user$project$Api$decodeTrack;
		} else {
			return _user$project$Soundcloud$decodeTrack;
		}
	}();
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Feed_Update$FetchFail(playlist.id),
		_user$project$Feed_Update$FetchSuccess(playlist.id),
		A2(_user$project$Api$fetchPlaylist, playlist.nextLink, trackDecoder));
};
var _user$project$Feed_Update$FetchMore = function (a) {
	return {ctor: 'FetchMore', _0: a};
};
var _user$project$Feed_Update$AddToCustomQueue = function (a) {
	return {ctor: 'AddToCustomQueue', _0: a};
};
var _user$project$Feed_Update$PlayFromPlaylist = F3(
	function (a, b, c) {
		return {ctor: 'PlayFromPlaylist', _0: a, _1: b, _2: c};
	});
var _user$project$Feed_Update$PlayFromCustomQueue = F2(
	function (a, b) {
		return {ctor: 'PlayFromCustomQueue', _0: a, _1: b};
	});
var _user$project$Feed_Update$UpdateCurrentTimeFail = {ctor: 'UpdateCurrentTimeFail'};
var _user$project$Feed_Update$UpdateCurrentTime = function (a) {
	return {ctor: 'UpdateCurrentTime', _0: a};
};
var _user$project$Feed_Update$KeyPressed = function (a) {
	return {ctor: 'KeyPressed', _0: a};
};
var _user$project$Feed_Update$ChangePage = function (a) {
	return {ctor: 'ChangePage', _0: a};
};
var _user$project$Feed_Update$BlacklistTrack = function (a) {
	return {ctor: 'BlacklistTrack', _0: a};
};
var _user$project$Feed_Update$MoveToPlaylistSuccess = {ctor: 'MoveToPlaylistSuccess'};
var _user$project$Feed_Update$MoveToPlaylistFail = function (a) {
	return {ctor: 'MoveToPlaylistFail', _0: a};
};
var _user$project$Feed_Update$MoveToPlaylist = F2(
	function (a, b) {
		return {ctor: 'MoveToPlaylist', _0: a, _1: b};
	});
var _user$project$Feed_Update$Rewind = {ctor: 'Rewind'};
var _user$project$Feed_Update$FastForward = {ctor: 'FastForward'};
var _user$project$Feed_Update$TrackError = function (a) {
	return {ctor: 'TrackError', _0: a};
};
var _user$project$Feed_Update$Pause = {ctor: 'Pause'};
var _user$project$Feed_Update$Play = {ctor: 'Play'};
var _user$project$Feed_Update$TrackProgress = function (a) {
	return {ctor: 'TrackProgress', _0: a};
};
var _user$project$Feed_Update$Next = {ctor: 'Next'};
var _user$project$Feed_Update$TogglePlayback = {ctor: 'TogglePlayback'};
var _user$project$Feed_Update$update = F2(
			...
			switch (_p2.ctor) {
				case 'FetchSuccess':
					...
					var updatePlaylist = function (playlist) {
						return _elm_lang$core$Native_Utils.eq(playlist.id, _p3) ? _elm_lang$core$Native_Utils.update(
							playlist,
							{nextLink: _p2._1._1, loading: false}) : playlist;
					};
				...
				case 'PlayFromPlaylist':
					var msg = _elm_lang$core$Native_Utils.eq(
						_user$project$Player$currentTrack(model.player),
						_elm_lang$core$Maybe$Just(_p2._2.id)) ? _user$project$Feed_Update$TogglePlayback : _user$project$Feed_Update$Play;
					var _v2 = msg,
						_v3 = _elm_lang$core$Native_Utils.update(
						model,
						{
							player: A3(_user$project$Player$select, _p2._0, _p2._1, model.player)
						});
					message = _v2;
					model = _v3;
					continue update;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								player: A3(
									_user$project$Player$appendTracksToPlaylist,
									_user$project$Feed_Model$CustomQueue,
									_elm_lang$core$Native_List.fromArray(
										[_p2._0]),
									model.player)
							}),
				...
				case 'FetchMore':
					...
					var fetchMoreHelp = function (playlist) {
						return _elm_lang$core$Native_Utils.eq(playlist.id, _p5) ? _user$project$Feed_Update$fetchMore(playlist) : _elm_lang$core$Platform_Cmd$none;
					};
					var updatePlaylist = function (playlist) {
						return _elm_lang$core$Native_Utils.eq(playlist.id, _p5) ? _elm_lang$core$Native_Utils.update(
							playlist,
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{playlists: updatedPlaylists}),
						A2(_elm_lang$core$List$map, fetchMoreHelp, model.playlists));
				case 'UpdateCurrentTimeFail':
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				case 'UpdateCurrentTime':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								currentTime: _elm_lang$core$Maybe$Just(_p2._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Play':
					var _p6 = _user$project$Feed_Model$currentTrack(model);
					if (_p6.ctor === 'Nothing') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{playing: true}),
							_1: _user$project$PlayerEngine$play(_p6._0)
						};
					}
				case 'Pause':
					return {
				...
				case 'TrackError':
					...
					var _p7 = A2(_user$project$Feed_Update$update, _user$project$Feed_Update$Next, newModel);
					var newModel$ = _p7._0;
					var command = _p7._1;
					return {ctor: '_Tuple2', _0: newModel$, _1: command};
				case 'TogglePlayback':
					if (model.playing) {
						var _v5 = _user$project$Feed_Update$Pause,
							_v6 = model;
						message = _v5;
						model = _v6;
						continue update;
					} else {
						var _v7 = _user$project$Feed_Update$Play,
							_v8 = model;
						message = _v7;
						model = _v8;
						continue update;
				...
				case 'Next':
					var _v9 = _user$project$Feed_Update$Play,
				...
				case 'PlayFromCustomQueue':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								playing: true,
								player: A3(_user$project$Player$select, _user$project$Feed_Model$CustomQueue, _p2._0, model.player)
							}),
						_1: _user$project$PlayerEngine$play(_p2._1)
					};
				case 'TrackProgress':
					return {
						ctor: '_Tuple2',
								...
								tracks: A3(
									...
									_elm_lang$core$Maybe$map(
										function (track) {
											return _elm_lang$core$Native_Utils.update(
												track,
												{progress: _p2._0._1, currentTime: _p2._0._2});
										}),
									model.tracks)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
				...
				case 'SeekTo':
					var _p9 = _p2._0;
					var _p8 = A2(_elm_lang$core$Debug$log, 'coucou', _p9);
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(
				...
				case 'MoveToPlaylist':
					...
					var targetPlaylist = _elm_lang$core$List$head(
						A2(
							...
							model.playlists));
					var cmd = function () {
						var _p11 = targetPlaylist;
						if (_p11.ctor === 'Nothing') {
							return _elm_lang$core$Platform_Cmd$none;
						} else {
							return A2(_user$project$Feed_Update$addTrack, _p11._0.addTrackUrl, _p13);
						}
					}();
					var player = A3(_user$project$Player$moveTrack, _p12, _p13, model.player);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				case 'MoveToPlaylistSuccess':
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				case 'BlacklistTrack':
					var _p14 = A2(_user$project$Feed_Update$update, _user$project$Feed_Update$Next, model);
					var newModel = _p14._0;
					var command = _p14._1;
					var _p15 = A2(
						_user$project$Feed_Update$update,
						A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$Blacklist, _p2._0),
						newModel);
				...
				case 'PublishFromSoundcloudUrl':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_user$project$Feed_Update$publishFromSoundcloudUrl, model.soundcloudClientId, _p2._0)
					};
				...
				case 'PublishFromSoundcloudUrlSuccess':
					...
					var model$ = _elm_lang$core$Native_Utils.update(
						model,
						{
							tracks: A3(_elm_lang$core$Dict$insert, _p18.id, _p18, model.tracks)
						});
					var _p16 = A2(
						_user$project$Feed_Update$update,
						A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$PublishedTracks, _p18.id),
						model$);
					var model$$ = _p16._0;
					var command = _p16._1;
					var _p17 = A2(
				...
				case 'ParseYoutubeUrl':
					...
					var track = A2(
						...
						_user$project$Youtube$extractYoutubeIdFromUrl(_p19));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				case 'PublishYoutubeTrack':
					return {
						...
						_1: _user$project$Feed_Update$publishYoutubeTrack(_p2._0)
					};
				...
				case 'PublishYoutubeTrackSuccess':
					...
					var model$ = _elm_lang$core$Native_Utils.update(
						model,
						{
							tracks: A3(_elm_lang$core$Dict$insert, _p22.id, _p22, model.tracks)
						});
					var _p20 = A2(
						_user$project$Feed_Update$update,
						A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$PublishedTracks, _p22.id),
						model$);
					var model$$ = _p20._0;
					var command = _p20._1;
					var _p21 = A2(
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[command, command$]));
				default:
					var _p23 = _elm_lang$core$Char$fromCode(_p2._0);
					switch (_p23.valueOf()) {
						case 'n':
							var _v13 = _user$project$Feed_Update$Next,
								_v14 = model;
							message = _v13;
							model = _v14;
							continue update;
						case 'p':
							var _v15 = _user$project$Feed_Update$TogglePlayback,
								_v16 = model;
							message = _v15;
							model = _v16;
							continue update;
						case 'l':
							var _v17 = _user$project$Feed_Update$FastForward,
								_v18 = model;
							message = _v17;
							model = _v18;
							continue update;
						case 'h':
							var _v19 = _user$project$Feed_Update$Rewind,
								_v20 = model;
							message = _v19;
							model = _v20;
							continue update;
						case 'L':
							var _p24 = model.currentPage.playlist;
							if (_p24.ctor === 'Just') {
								var _p25 = _p24._0;
								switch (_p25.ctor) {
									case 'Feed':
										var _v23 = _user$project$Feed_Update$ChangePage('/saved-tracks'),
											_v24 = model;
										message = _v23;
										model = _v24;
										continue update;
									case 'SavedTracks':
										var _v25 = _user$project$Feed_Update$ChangePage('/published-tracks'),
											_v26 = model;
										message = _v25;
										model = _v26;
										continue update;
									case 'PublishedTracks':
										var _v27 = _user$project$Feed_Update$ChangePage('/'),
											_v28 = model;
										message = _v27;
										model = _v28;
										continue update;
						...
						case 'H':
							var _p26 = model.currentPage.playlist;
							if (_p26.ctor === 'Just') {
								var _p27 = _p26._0;
								switch (_p27.ctor) {
									case 'Feed':
										var _v31 = _user$project$Feed_Update$ChangePage('/published-tracks'),
											_v32 = model;
										message = _v31;
										model = _v32;
										continue update;
									case 'SavedTracks':
										var _v33 = _user$project$Feed_Update$ChangePage('/'),
											_v34 = model;
										message = _v33;
										model = _v34;
										continue update;
									case 'PublishedTracks':
										var _v35 = _user$project$Feed_Update$ChangePage('/saved-tracks'),
											_v36 = model;
										message = _v35;
										model = _v36;
										continue update;
						...
						case 'm':
							var _p28 = model.currentPage.playlist;
							if (_p28.ctor === 'Just') {
								var _v38 = _user$project$Feed_Update$FetchMore(_p28._0),
									_v39 = model;
								message = _v38;
								model = _v39;
								continue update;
						...
						case 'b':
							...
							if (_p29.ctor === 'Nothing') {
								...
								var _v41 = _user$project$Feed_Update$BlacklistTrack(_p29._0),
									_v42 = model;
								message = _v41;
								model = _v42;
								continue update;
						...
						case 's':
							...
							if (_p30.ctor === 'Nothing') {
								...
								var _v44 = A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$SavedTracks, _p30._0),
									_v45 = model;
								message = _v44;
								model = _v45;
								continue update;
						...
						case 'P':
							var _p31 = _user$project$Player$currentTrack(model.player);
							if (_p31.ctor === 'Nothing') {
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							} else {
								var _v47 = A2(_user$project$Feed_Update$MoveToPlaylist, _user$project$Feed_Model$PublishedTracks, _p31._0),
									_v48 = model;
								message = _v47;
								model = _v48;
								continue update;
						...
						case 'j':
							return {
								ctor: '_Tuple2',
								_0: model,
								_1: _user$project$Feed_Ports$scroll(120)
							};
						case 'k':
							return {
								ctor: '_Tuple2',
						...
						case 'g':
							return _elm_lang$core$Native_Utils.eq(
								...
								_1: _user$project$Feed_Ports$scroll(-9999999)
							} : {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
						...
						case 'G':
							return {
								ctor: '_Tuple2',
								_0: model,
								_1: _user$project$Feed_Ports$scroll(99999999)
							};
						default:
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
			...
			return A2(
				...
				_elm_lang$core$Maybe$oneOf(
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'year', _1: year},
								{ctor: '_Tuple2', _0: 'month', _1: month},
								{ctor: '_Tuple2', _0: 'week', _1: week},
								{ctor: '_Tuple2', _0: 'day', _1: day},
								{ctor: '_Tuple2', _0: 'hour', _1: _elm_lang$core$Time$hour},
								{ctor: '_Tuple2', _0: 'minute', _1: _elm_lang$core$Time$minute}
							]))));
		}
	});

var _user$project$View$viewNavigationItem = F4(
	function (changePage, currentPage, currentPlaylistPage, navigationItem) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Json_Decode$succeed(
						changePage(navigationItem.href)))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
						...
						_elm_lang$html$Html_Attributes$classList(
							_elm_lang$core$Native_List.fromArray(
								[
									...
									ctor: '_Tuple2',
									_0: 'active',
									_1: _elm_lang$core$Native_Utils.eq(navigationItem.href, currentPage.url)
								},
									{
									ctor: '_Tuple2',
									_0: 'playing',
...
var _user$project$View$viewNavigation = F5(
	function (changePage, navigationItems, pages, currentPage, currentPlaylist) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$html$Html_Events$onClick(
				_user$project$Feed_Update$FetchMore(playlistId))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Feed_View$viewTrackPlaceHolder = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$Feed_View$viewTrack = F4(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Events$onClick(
					A3(_user$project$Feed_Update$PlayFromPlaylist, playlistId, position, track))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
										...
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Json_Decode$succeed(
														_user$project$Feed_Update$AddToCustomQueue(track.id)))
												]),
											_elm_lang$core$Native_List.fromArray(
												[
...
var _user$project$Feed_View$viewPlaylist = F4(
	function (currentTime, tracks, playlist, playlistContent) {
		...
		var tracksView = A2(
			...
			A2(_user$project$Feed_View$viewTrack, currentTime, playlist.id),
			playlistTracks);
		return _elm_lang$core$Native_Utils.eq(playlist.loading, true) ? A2(
			...
			A2(
				_elm_lang$core$List$append,
				tracksView,
				A2(_elm_lang$core$List$repeat, 10, _user$project$Feed_View$viewTrackPlaceHolder))) : A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Feed_View$viewMoreButton(playlist.id)
					])));
	});
var _user$project$Feed_View$viewCustomPlaylistItem = F2(
	function (position, track) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('custom-queue-track'),
					_elm_lang$html$Html_Events$onClick(
					A2(_user$project$Feed_Update$PlayFromCustomQueue, position, track))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _user$project$Feed_View$viewCustomQueue = F2(
	function (tracks, queue) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('custom-queue')
				]),
			A2(
				_elm_lang$core$List$indexedMap,
				_user$project$Feed_View$viewCustomPlaylistItem,
				A2(
					_elm_lang$core$List$filterMap,
					function (trackId) {
						return A2(_elm_lang$core$Dict$get, trackId, tracks);
...
var _user$project$Feed_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Feed_Update$ChangePage,
				model.navigation,
				model.pages,
				model.currentPage,
				_user$project$Player$currentPlaylist(model.player)),
				A2(
				_user$project$Feed_View$viewCustomQueue,
				model.tracks,
				A2(_user$project$Player$playlistContent, _user$project$Feed_Model$CustomQueue, model.player)),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Feed_Main$navigation = _elm_lang$core$Native_List.fromArray(
	[
		A2(_user$project$Feed_Model$NavigationItem, 'Feed', '/feed'),
		A2(_user$project$Feed_Model$NavigationItem, 'saved tracks', '/feed/saved-tracks'),
		A2(_user$project$Feed_Model$NavigationItem, 'published tracks', '/feed/published-tracks'),
		A2(_user$project$Feed_Model$NavigationItem, '+', '/feed/publish-track')
	]);
var _user$project$Feed_Main$pages = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_user$project$Feed_Model$Page,
		'/',
		_elm_lang$core$Maybe$Just(_user$project$Feed_Model$Feed)),
		A2(
		_user$project$Feed_Model$Page,
		'/feed/saved-tracks',
		_elm_lang$core$Maybe$Just(_user$project$Feed_Model$SavedTracks)),
		A2(
		_user$project$Feed_Model$Page,
		'/feed/published-tracks',
		_elm_lang$core$Maybe$Just(_user$project$Feed_Model$PublishedTracks)),
		A2(_user$project$Feed_Model$Page, '/feed/publish-track', _elm_lang$core$Maybe$Nothing)
	]);
var _user$project$Feed_Main$playlists = _elm_lang$core$Native_List.fromArray(
	[
		A3(_user$project$Feed_Model$emptyPlaylist, _user$project$Feed_Model$Feed, '/feed/feed', 'fake-url'),
		A3(_user$project$Feed_Model$emptyPlaylist, _user$project$Feed_Model$SavedTracks, '/feed/saved_tracks', '/feed/save_track'),
		A3(_user$project$Feed_Model$emptyPlaylist, _user$project$Feed_Model$PublishedTracks, '/feed/published_tracks', '/feed/publish_track'),
		A3(_user$project$Feed_Model$emptyPlaylist, _user$project$Feed_Model$Blacklist, '/feed/blacklist', '/feed/blacklist')
	]);
var _user$project$Feed_Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$PlayerEngine$trackProgress(_user$project$Feed_Update$TrackProgress),
				_user$project$PlayerEngine$trackEnd(
				function (_p0) {
					return _user$project$Feed_Update$Next;
				}),
				_user$project$PlayerEngine$trackError(_user$project$Feed_Update$TrackError),
...
var _user$project$Feed_Main$init = F2(
	function (soundcloudClientId, page) {
		return {
			ctor: '_Tuple2',
			_0: {
				tracks: _elm_lang$core$Dict$empty,
				playlists: _user$project$Feed_Main$playlists,
				playing: false,
				currentPage: page,
				lastKeyPressed: _elm_lang$core$Maybe$Nothing,
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				A2(
					_elm_lang$core$List$append,
					A2(_elm_lang$core$List$map, _user$project$Feed_Update$fetchMore, _user$project$Feed_Main$playlists),
					_elm_lang$core$Native_List.fromArray(
						[
							A3(
							_elm_lang$core$Task$perform,
							function (_p1) {
								return _user$project$Feed_Update$UpdateCurrentTimeFail;
							},
							_user$project$Feed_Update$UpdateCurrentTime,
							_elm_lang$core$Time$now)
						])))
		};
	});
var _user$project$Feed_Main$urlUpdate = F2(
	function (page, model) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Feed_Main$urlParser = _elm_lang$navigation$Navigation$makeParser(
	function (_p2) {
		var _p3 = _p2;
		return A2(
			_elm_lang$core$Maybe$withDefault,
			...
			_elm_lang$core$List$head(
				A2(
					...
					_user$project$Feed_Main$pages)));
	});
var _user$project$Feed_Main$main = {
	main: A2(
		_elm_lang$navigation$Navigation$programWithFlags,
		_user$project$Feed_Main$urlParser,
		{init: _user$project$Feed_Main$init, view: _user$project$Feed_View$view, update: _user$project$Feed_Update$update, urlUpdate: _user$project$Feed_Main$urlUpdate, subscriptions: _user$project$Feed_Main$subscriptions}),
	flags: _elm_lang$core$Json_Decode$string
};

var Elm = {};
Elm['Feed'] = Elm['Feed'] || {};
Elm['Feed']['Main'] = Elm['Feed']['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Feed']['Main'], 'Feed.Main', typeof _user$project$Feed_Main$main === 'undefined' ? null : _user$project$Feed_Main$main);
